...
//移除版本号
function canuxtheme_remove_cssjs_ver( $src ) {
	if( strpos( $src, 'ver='. get_bloginfo( 'version' ) ) )
		$src = remove_query_arg( 'ver', $src );
	return $src;
}
add_filter( 'style_loader_src', 'canuxtheme_remove_cssjs_ver', 999 );
add_filter( 'script_loader_src', 'canuxtheme_remove_cssjs_ver', 999 );
