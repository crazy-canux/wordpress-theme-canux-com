...
<p>
 ...
 <input type="text" size="40"  readonly="true" value="付费版功能"/>
 
 <a id="ashu_upload" class="left_right_upload_button button" href="#">上传</a>
 
 <em style="padding:3px; background:#FCF3E4; border:solid 1px #F0D8BF; display:block;">付费版可以设置一个视频作为你的背景</em>
</p> 
...
<p>   
 ...
 <div  id="up_down_mod" class="swiper-slide  <?php if ($first_mod == "1" ) {echo "swiper-slide-active";}?> up_down" > 
                  ...
                  <?php if($my_images&&$left_right){ ?>
                   ...
                   <div class="up_text <?php echo $my_text_colors ?>"  <?php echo $tup_xy; ?> >
                     <div <?php echo $my_text_alphas ?> id="alpha">
                      <?php if( $my_text2) {?>  <h3><a href="#"><?php echo  $my_text2; ?></a></h3><?php } ?>
      ...
      <div class="index_mod_bag <?php if(!$my_b_images_ad){echo 'bag_animate'; } ?> " style=" background-image:url(<?php if($my_b_images){echo $my_b_images ;}else{ echo get_bloginfo('template_url').'/images/demo/2.jpg'; }?>)">
