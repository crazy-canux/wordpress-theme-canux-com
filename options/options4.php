...
<b class="bt">多语言翻译</b><br />
           ...
           <input type="text" size="20"  name="language1" id="language1" value="<?php if($language1){ echo $language1;}else{echo get_bloginfo('template_url').'/images/chinese_canux.gif';}  ?>"/  />
           ...
           <input type="text" size="20"  name="language2" id="language2" value="<?php if($language2){ echo $language2;}else{echo get_bloginfo('template_url').'/images/english_canux.gif';}  ?>"/  />
            <input type="button" name="upload_button" value="上传" id="upbottom"/>
 ...
 <p>对照左边的中文，你可以吧这些固定的词语替换成你想要的，如果你不是多语言网站，也可以使用这个功能改变你想要改变的文字。</p>
  ...
  <p> <label  for="word_t1">查看详细：</label>
    ...
    <p> <label  for="word_t29">发送邮件：</label>
     ...
     <p> <label  for="word_t2">Copyright：</label>
     <input type="text" size="20"  name="word_t2" id="word_t2" value="<?php if($word_t2!=""){echo $word_t2;}else{echo 'Copyright';}  ?>"/  />
   </p>
